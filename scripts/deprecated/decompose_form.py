...
-> output/form_itemised.md, then stop. Review against the actual form.

--decompose: read the (reviewed) form_itemised.md -> output/form_questions.json.
"""
...
def decompose():
    itemised_path = OUTPUT / "form_itemised.md"
